...
def get_data(base_path, fuzzing_criteria, prefix, axs, iter, type):
    ax_num = 0
    # { cri1:[strategy1,strategy2,...] }
    for cri, strategy in fuzzing_criteria.items():
        ax = axs[ax_num]
...
if __name__ == "__main__":
    ...
    # parser.add_argument('-m',help='the chosen models')
    ...
    input = args.i
    # models = args.m
    base_path = input  # os.path.join(input,models)

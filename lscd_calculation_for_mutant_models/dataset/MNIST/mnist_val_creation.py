...
mnist_train = datasets.MNIST(root="/data/disk2/test/", train=True, download=True, transform=transform)
mnist_test = datasets.MNIST(root="/data/disk2/test/", train=False, download=True, transform=transform)
...
torch.save(mnist_train_samples, "/data/disk2/test/mnist_train.pth")
torch.save(mnist_val_samples, "/data/disk2/test/mnist_validation.pth")

mnist_test_samples = []
for img, label in mnist_test:
    mnist_test_samples.append((img, label))

torch.save(mnist_test_samples, "/data/disk2/test/mnist_test.pth")

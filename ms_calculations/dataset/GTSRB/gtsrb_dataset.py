...
import sys
sys.path.append("..")
from dataset.GTSRB.base_gtsrb_dataset import BaseDataset
...
class GTSRBDataset(BaseDataset):
    ...
    def __init__(self, config, path, image_set, mode, augmentation) -> None:
        super().__init__(config, path, image_set, mode, augmentation)
    ...
    def _load_annotations(self) -> Tuple[List, List, List, List]:
        ...
        with open(os.path.join(self._root_path, file_name), newline="") as csvfile:

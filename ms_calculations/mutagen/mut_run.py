...
def get_mutation_ops() -> Dict[str, MutOp]:
    ...
    for file in Path("mutation_ops").glob("*.py"):
...
def main(config_file: str):
    ...
    output_folder = Path.cwd() / 'results' / datetime.now().strftime("%Y_%m_%d_%H_%M_%S") / 'raw_mutants'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-config_file', default="configs/gtsrb/ref.ini")

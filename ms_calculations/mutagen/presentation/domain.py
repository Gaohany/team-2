...
red_circle_keys = [
    int(GTSRBLabelEnum.MAX_SPEED_20),
    int(GTSRBLabelEnum.MAX_SPEED_30),
    int(GTSRBLabelEnum.MAX_SPEED_50),
    int(GTSRBLabelEnum.MAX_SPEED_60),
    int(GTSRBLabelEnum.MAX_SPEED_70),
    int(GTSRBLabelEnum.MAX_SPEED_80),
    int(GTSRBLabelEnum.MAX_SPEED_100),
    int(GTSRBLabelEnum.MAX_SPEED_120),
    int(GTSRBLabelEnum.NO_OVERTAKING),
    int(GTSRBLabelEnum.NO_OVERTAKING_FOR_TRUCKS),
    int(GTSRBLabelEnum.NO_VEHICLES_PERMITTED_CIRCLE),
]
blue = {

# Applied mutation op ChangeKeywordInAssign with args: dict_items([('member', 'conv2'), ('keyword', 'bias'), ('value', 'False')])
...
class Net(nn.Module):
    ...
    def __init__(self, num_classes: int=10, drop_rate: float=0.0):
        ...
        self.ac1 = nn.ReLU()
        self.conv2 = nn.Conv2d(self.conv1.out_channels, 16, kernel_size=5, stride=1, padding=0, bias=False)

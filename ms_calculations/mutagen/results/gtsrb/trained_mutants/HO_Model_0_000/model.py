# Applied mutation op ChangeActivation with args: dict_items([('member', 'ac2'), ('activation', 'Tanh')])
# Applied mutation op RemoveBatchNorm with args: dict_items([('member', 'bn2')])
...
class Net(nn.Module):
    ...
    def __init__(self, num_classes: int=43, drop_out: float=0.5):
        ...
        self.bn2 = nn.Identity(self.conv2.out_channels)
        self.ac2 = nn.Tanh()

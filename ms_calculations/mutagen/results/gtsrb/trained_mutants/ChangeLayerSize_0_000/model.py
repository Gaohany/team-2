# Applied mutation op ChangeKeywordInAssign with args: dict_items([('member', 'conv1'), ('keyword', 'out_channels'), ('value', '16')])
...
class Net(nn.Module):
    ...
    def __init__(self, num_classes: int=43, drop_out: float=0.5):
        ...
        self.conv1 = nn.Conv2d(3, out_channels=16, kernel_size=5, bias=True)
